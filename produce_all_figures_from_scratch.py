...
GROUPING_RARE_CATEGORIES_N_REPETITIONS = 10**4 #10**7

VARIABLE_SELECTED_LINREG_REPS_LOWDIM = 10**3 # 10**6
VARIABLE_SELECTED_LINREG_REPS_HIGHDIM = 10**3 # 10**6

VARIABLE_SELECTED_LINREG_REPS_SUPERCONDUCTIVITY = 10**3 # 10**6

RESCALED_LASSO_LOW_DIM_N_REPETITIONS = 10**4 # 10**7
RESCALED_LASSO_HIGH_DIM_N_REPETITIONS = 10**3 # 10**6

CV_PIPELINE_LOW_DIM_N_REPETITIONS = 10**2 # 10**5
CV_PIPELINE_HIGH_DIM_N_REPETITIONS = 10**2 # 10**5
